...
public class PostoREST {
  ...
  public HttpEntity<PagedResources<Posto>> listByNomeParams (@PathVariable("nome") java.lang.String nome, Pageable pageable, PagedResourcesAssembler assembler){
    return new ResponseEntity<>(assembler.toResource(postoBusiness.listByNome(nome, pageable)), HttpStatus.OK);
  }
