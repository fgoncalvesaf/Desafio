...
public class AbastecimentoREST {
  ...
  /**
   * NamedQuery listByCarro
   * @generated
   */
  @RequestMapping(method = RequestMethod.GET
  , value="/listByCarro/{carroId}")
  public HttpEntity<PagedResources<Abastecimento>> listByCarroParams (@PathVariable("carroId") java.lang.String carroId, Pageable pageable, PagedResourcesAssembler assembler){
    return new ResponseEntity<>(assembler.toResource(abastecimentoBusiness.listByCarro(carroId, pageable)), HttpStatus.OK);
  }
  /**
   * NamedQuery listByPosto
   * @generated
   */
  @RequestMapping(method = RequestMethod.GET
  , value="/listByPosto/{postoId}")
  public HttpEntity<PagedResources<Abastecimento>> listByPostoParams (@PathVariable("postoId") java.lang.String postoId, Pageable pageable, PagedResourcesAssembler assembler){
    return new ResponseEntity<>(assembler.toResource(abastecimentoBusiness.listByPosto(postoId, pageable)), HttpStatus.OK);
  }
  /**
   ...
   */
  @RequestMapping(method = RequestMethod.GET
  , value="/listByUser/{userId}")
  public HttpEntity<PagedResources<Abastecimento>> listByUserParams (@PathVariable("userId") java.lang.String userId, Pageable pageable, PagedResourcesAssembler assembler){
    return new ResponseEntity<>(assembler.toResource(abastecimentoBusiness.listByUser(userId, pageable)), HttpStatus.OK);
  }
