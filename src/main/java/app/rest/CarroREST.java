...
public class CarroREST {
  ...
  /**
   * NamedQuery listByModelo
   * @generated
   */
  @RequestMapping(method = RequestMethod.GET
  , value="/listByModelo/{modelo}")
  public HttpEntity<PagedResources<Carro>> listByModeloParams (@PathVariable("modelo") java.lang.String modelo, Pageable pageable, PagedResourcesAssembler assembler){
    return new ResponseEntity<>(assembler.toResource(carroBusiness.listByModelo(modelo, pageable)), HttpStatus.OK);
  }
  /**
   * NamedQuery listByPlaca
   * @generated
   */
  @RequestMapping(method = RequestMethod.GET
  , value="/listByPlaca/{placa}")
  public HttpEntity<PagedResources<Carro>> listByPlacaParams (@PathVariable("placa") java.lang.String placa, Pageable pageable, PagedResourcesAssembler assembler){
    return new ResponseEntity<>(assembler.toResource(carroBusiness.listByPlaca(placa, pageable)), HttpStatus.OK);
  }
