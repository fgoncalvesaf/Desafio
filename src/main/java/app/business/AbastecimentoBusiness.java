...
public class AbastecimentoBusiness {
   ...
   * @generated
   */
  public Page<Abastecimento> listByCarro( java.lang.String carroId, Pageable pageable){
    // begin-user-code
    // end-user-code
    Page<Abastecimento> result = repository.listByCarro( carroId, pageable);
    // begin-user-code
    // end-user-code
    return result;
  }
   ...
   * @generated
   */
  public Page<Abastecimento> listByPosto( java.lang.String postoId, Pageable pageable){
    // begin-user-code
    // end-user-code
    Page<Abastecimento> result = repository.listByPosto( postoId, pageable);
    // begin-user-code
    // end-user-code
    return result;
  }
   ...
   * @generated
   */
  public Page<Abastecimento> listByUser( java.lang.String userId, Pageable pageable){
    // begin-user-code
    // end-user-code
    Page<Abastecimento> result = repository.listByUser( userId, pageable);
    // begin-user-code
    // end-user-code
    return result;
  }
