 ...
 */
@Entity
@Table(name = "\"CARRO\"" ,uniqueConstraints=@UniqueConstraint(columnNames={
"placa" }))
@XmlRootElement
public class Carro implements Serializable {
  ...
  * @generated
  */
  @Column(name = "placa", nullable = true, unique = true, length=7, insertable=true, updatable=true)
  ...
  * @generated
  */
  @Column(name = "ano", nullable = true, unique = false, length=4, insertable=true, updatable=true)
