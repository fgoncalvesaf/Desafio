...
public interface PostoDAO extends JpaRepository<Posto, java.lang.String> {
   ...
   * @generated
   */
  @Query("select p from Posto p where p.nome LIKE CONCAT('%', COALESCE(:nome, p.nome),'%')")
  public Page<Posto> listByNome(@Param(value="nome") java.lang.String nome, Pageable pageable);
